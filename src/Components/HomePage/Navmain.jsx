...
const Navmain = () => {
  return (
    ...
    <Flex w="100%" > 
        <MobileNavbar/>
        <Flex display={{base:"none", md:"flex"}} direction={"column"} gap={10} mb='60px' id="maindiv"  backgroundColor='#fff'  >
            <Navigationbar/>
...
const LineNavCompo = ({ name}) => {
  ...
  return (
    <Center cursor='pointer' textAlign='center' w='180px' fontSize='14px' h='1cm' href='#' _hover={{ color: '#24a3b5' }}>
      {name}
    </Center>
  )
