    ...
    <div className="footer mt-5">
      ...
      <div className="row">
        <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Shopper Central </h5>
              <ul className="list-unstyled">
                ...
                <li>
                  <a href="#nothing"> Cares</a>
                </li>
                <li>
                  <a href="#nothing">Stories</a>
                </li>
                <li>
                  <a href="#nothing">Gift a Smile</a>
                </li>
        ...
        <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Merchant Central</h5>
              <ul className="list-unstyled">
                <li>
        ...
        <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">About Us</h5>
              <ul className="list-unstyled">
                <li>
        ...
        <div className="col-12 col-lg p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Connect Us</h5>
              <ul className="list-unstyled">
                <li>
        ...
        <div className="col-12 col-lg p-0 m-0">
          <div className="card border-0 bg-transparent">
            <div className="card-body">
              <h5 className="card-title text-white">Press</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#nothing">In the news</a>
                </li>
          ...
          <div className="desktop-section">
            <div className="desktop-original">
              ...
              <div className="promise">
                ...
                <br /> guarantee for all products at  Digital{" "}
              </div>
            </div>
          </div>
          <div className="desktop-section">
